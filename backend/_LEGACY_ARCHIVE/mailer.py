...
async def send_interview_invitation(candidate_name, candidate_email, scheduled_at, room_link):
    """
    ...
    return await loop.run_in_executor(None, _send_sync, candidate_name, candidate_email, scheduled_at, room_link)

def _send_sync(candidate_name, candidate_email, scheduled_at, room_link):

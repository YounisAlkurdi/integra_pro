...
async def dispatch_async(provider: str, config: Dict[str, Any], operation: str, payload: Dict[str, Any] = None) -> Any:
    """Execute dynamic operations on the external matrix provider asynchronously."""
    payload = payload or {}
...
def dispatch_sync(provider: str, config: Dict[str, Any], operation: str, payload: Dict[str, Any] = None) -> Any:
    """Synchronous version of dispatch for use in older sync code."""
    payload = payload or {}
